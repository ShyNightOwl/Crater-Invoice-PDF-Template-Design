...
<head>
    ...
    .header-section-right {padding: 14px 30px 14px 0px; display: inline-block; width: 35%; float: right; text-align: right; color: #ffffff;}
...
<body>
		...
		<table width="100%">
			<tr>
				...
				<td width="40%" class="header-section-right estimate-details-container">
					...
					<h4>Estimate No.: {{ $estimate->estimate_number }}</h4>
					<h4>Estimate Date: {{ $estimate->formattedEstimateDate }}</h4>
    ...
    <div style="clear: both;">@include('app.pdf.estimate.partials.table')</div>
		...
		<table width="100%">
			<tr>
				<td width="50%" class="signature-section-left">
					Authorised Signatory For, <h4 class="signature-title">{{ $estimate->customer->company->name }}<br>( CEO / Owner )</h4>
					<h5>Accepted & Signed Date: ________/________/________</h5>
				</td>
				<td width="50%" class="signature-section-right">
					Authorised Signatory For, <h4 class="signature-title">{{ $estimate->customer->billingaddress->name }}<br>( {{ $estimate->customer->contact_name }} )</h4>
					<h5>Accepted & Signed Date: ________/________/________</h5>
				</td>
			</tr>
		</table>
...
<footer id="footer" style="clear: both;">
	<!-- <h4>{{ $estimate->customer->company->name }}</h4> -->
    <h4>Copyright © {{ now()->year }} {{ $estimate->customer->company->name }}. All Rights Reserved.</h4>
</footer>
</body>
</html>