<table width="100%" class="items-table" cellspacing="0" border="0" style="clear: both;">
    <tr class="item-table-heading-row">
        <th width="2%" class="pr-20 text-right item-table-heading">#</th>
        <th width="40%" class="pl-10 text-left item-table-heading">@lang('pdf_items_label')</th>
...
<div class="total-display-container" style="clear: both;">
